...
var r: Double = 10      // var定义变量，显式指定数据类型为Double
...
// 内容：使用元组存储你的信息，并输出。
// 1） 定义元组
let myInfo1 = ("liwei", "Male", 35);                        // 定义元组
let myInfo2: (String, String, Int) = ("liwei", "Male", 35)  // 定义元组，显示指定类型
var myInfo3 = (name:"liwei", gender:"Male", age:35)         // 定义元组：指定元素名称
...
print("My name is \(myInfo2.0) and my age is \(myInfo2.2)")
